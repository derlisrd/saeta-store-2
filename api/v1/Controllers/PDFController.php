...
class PDFController {
            ...
            <table class='items'>
               ...
               <tr><td colspan='6'><br/></td></tr>
                ...
                <tr class='total'>
                    ...
                    <td class='text-right'>".number_format($total_con_descuento, 2, ',', '.')."</td>
                </tr>
            </table>
    ...
    public static function factura($array){
        ...
        //$image_or_title = $df['logo_url_empresa'] === '' ? '<h5>'.$df['nombre_empresa'].'</h5>': '<img src="'.$df['logo_url_empresa'].'"  />';  
        $image_or_title = '<h5>'.$df['nombre_empresa'].'</h5>';
